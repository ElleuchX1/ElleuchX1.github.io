...
<img src="/assets/img/htb-breadcrumbs/e-book.png">

Seems like it's an e-book library

<img src="/assets/img/htb-breadcrumbs/eth.png">

We have a search page for books, let's try to play with it a bit

<img src="/assets/img/htb-breadcrumbs/ethtest.png">
...
Let's capture the request with burpsuite to see what's actually going on
 ...
 <img src="/assets/img/htb-breadcrumbs/LFI1.png">
...
Let's first send the request to repeater and change "method=1"
 ...
 <img src="/assets/img/htb-breadcrumbs/LFI21.png">

 <img src="/assets/img/htb-breadcrumbs/LFI22.png">
 ...
 <img src="/assets/img/htb-breadcrumbs/LFI3.png">
...
<img src="/assets/img/htb-breadcrumbs/gob.png">

Seems like we have a login panel


<img src="/assets/img/htb-breadcrumbs/login.png">
...
<img src="/assets/img/htb-breadcrumbs/gob1.png">

Let's check all of these


`/includes/`
<img src="/assets/img/htb-breadcrumbs/include.png">



`/php/`
<img src="/assets/img/htb-breadcrumbs/files.png">




<img src="/assets/img/htb-breadcrumbs/users.png">
...
<img src="/assets/img/htb-breadcrumbs/filecont.png">
...
<img src="/assets/img/htb-breadcrumbs/cookie.png">
...
<img src="/assets/img/htb-breadcrumbs/cok.png">

Let's try them one by one and check if we can get in

<img src="/assets/img/htb-breadcrumbs/adm1.png">

<img src="/assets/img/htb-breadcrumbs/adm.png">
...
<img src="/assets/img/htb-breadcrumbs/Issues.png">

Let's check the File management page

<img src="/assets/img/htb-breadcrumbs/file.png">

Let's try to upload anything to see if it works


<img src="/assets/img/htb-breadcrumbs/token.png">
...
<img src="/assets/img/htb-breadcrumbs/jwt.png">
...
<img src="/assets/img/htb-breadcrumbs/newjwt.png">

Let's to import anything 

<img src="/assets/img/htb-breadcrumbs/succ.png">
...
<img src="/assets/img/htb-breadcrumbs/foothold.png">
...
<img src="/assets/img/htb-breadcrumbs/data.png">

<img src="/assets/img/htb-breadcrumbs/userdata.png">
...
```
<img src="/assets/img/htb-breadcrumbs/userflag.png">
...
<img src="/assets/img/htb-breadcrumbs/userf.png">
...
<img src="/assets/img/htb-breadcrumbs/todo1.png">
<img src="/assets/img/htb-breadcrumbs/todo2.png">
...
<img src="/assets/img/htb-breadcrumbs/sticky.png">
...
<img src="/assets/img/htb-breadcrumbs/state.png">
...
```
<img src="/assets/img/htb-breadcrumbs/smb.png">
...
<img src="/assets/img/htb-breadcrumbs/sshdev.png">
...
<img src="/assets/img/htb-breadcrumbs/ff.png">
...
```
<img src="/assets/img/htb-breadcrumbs/kryp.png">
...
<img src="/assets/img/htb-breadcrumbs/rabin.png">
...
<img src="/assets/img/htb-breadcrumbs/local.png">
...
<img src="/assets/img/htb-breadcrumbs/for.png">
...
```
<img src="/assets/img/htb-breadcrumbs/us.png">

<img src="/assets/img/htb-breadcrumbs/AES.png">

We get the administrator's password but it's encrypted (AES) 

Let's use cyberchef to decrypt it

<img src="/assets/img/htb-breadcrumbs/root.png">
...
<img src="/assets/img/htb-breadcrumbs/rooted.png">
