...
date: '2021-04-17'
summary: Here's my writeup for the RETIRED machine Laboratory, Which is an Easy Linux
  machine!
tags: [HackTheBox, easy, Linux]
image: /assets/img/htb-Laboratory/featured.webp
---
...
<img decoding="async" loading="lazy" alt="users" src="/assets/img/htb-Laboratory/users.webp">
...
<img decoding="async" loading="lazy" alt="gitlab" src="/assets/img/htb-Laboratory/gitlab.webp">

Tried few logins but it failed, ( dexter:admin dexter:password )

Let's create our own account and see what we can do

<img decoding="async" loading="lazy" alt="reg" src="/assets/img/htb-Laboratory/reg.webp">

`GitLab Community Edition 12.8.1`

<img decoding="async" loading="lazy" alt="git ver" src="/assets/img/htb-Laboratory/git_ver.webp">
...
<img decoding="async" loading="lazy" alt="pro" src="/assets/img/htb-Laboratory/pro.webp">
...
<img decoding="async" loading="lazy" alt="passwd" src="/assets/img/htb-Laboratory/passwd.webp">

- Let's now move it to the other project

<img decoding="async" loading="lazy" alt="move" src="/assets/img/htb-Laboratory/move.webp">
<img decoding="async" loading="lazy" alt="passwd1" src="/assets/img/htb-Laboratory/passwd1.webp">
And we get the file!
<img decoding="async" loading="lazy" alt="passwd2" src="/assets/img/htb-Laboratory/passwd2.webp">
...
```
<img decoding="async" loading="lazy" alt="secret" src="/assets/img/htb-Laboratory/secret.webp">
...
<img decoding="async" loading="lazy" alt="docker" src="/assets/img/htb-Laboratory/docker.webp">
...
<img decoding="async" loading="lazy" alt="cookie" src="/assets/img/htb-Laboratory/cookie.webp">
...
<img decoding="async" loading="lazy" alt="foothold" src="/assets/img/htb-Laboratory/foothold.webp">
...
user.save!
```
<img decoding="async" loading="lazy" alt="dexterpass" src="/assets/img/htb-Laboratory/dexterpass.webp">

Let's login now with his account

<img decoding="async" loading="lazy" alt="projects" src="/assets/img/htb-Laboratory/projects.webp">

There is a private repo that contains his home directory backup!

<img decoding="async" loading="lazy" alt="ssh" src="/assets/img/htb-Laboratory/ssh.webp">

Let's copy his ssh private key and get into the box!

<img decoding="async" loading="lazy" alt="user" src="/assets/img/htb-Laboratory/user.webp">
...
<img decoding="async" loading="lazy" alt="suid" src="/assets/img/htb-Laboratory/suid.webp">

let's run Ltrace on this binary

<img decoding="async" loading="lazy" alt="ltrace" src="/assets/img/htb-Laboratory/ltrace.webp">
...
<img decoding="async" loading="lazy" alt="root" src="/assets/img/htb-Laboratory/root.webp">
