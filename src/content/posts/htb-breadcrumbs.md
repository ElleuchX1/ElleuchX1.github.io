...
date: '2021-07-17'
summary: Here's my writeup for the RETIRED machine Breadcrumbs, Which is an hard Windows
  machine!
tags: [HackTheBox, Hard, Windows]
image: /assets/img/htb-breadcrumbs/featured1.webp
---
...
![ebook](/assets/img/htb-breadcrumbs/e-book.webp)

Seems like it's an e-book library

![eth](/assets/img/htb-breadcrumbs/eth.webp)

We have a search page for books, let's try to play with it a bit

![ethtest](/assets/img/htb-breadcrumbs/ethtest.webp)
...
Let's capture the request with burpsuite to see what's actually going on
 ...
 ![lfi1](/assets/img/htb-breadcrumbs/LFI1.webp)
...
Let's first send the request to repeater and change "method=1"
 ...
 ![lfi21](/assets/img/htb-breadcrumbs/LFI21.webp)

 ![lfi22](/assets/img/htb-breadcrumbs/LFI22.webp)
 ...
 ![lfi3](/assets/img/htb-breadcrumbs/LFI3.webp)
...
![gob](/assets/img/htb-breadcrumbs/gob.webp)

Seems like we have a login panel


![login](/assets/img/htb-breadcrumbs/login.webp)
...
![gob](/assets/img/htb-breadcrumbs/gob1.webp)

Let's check all of these


`/includes/`
![gob2](/assets/img/htb-breadcrumbs/include.webp)



`/php/`
![files](/assets/img/htb-breadcrumbs/files.webp)




![users](/assets/img/htb-breadcrumbs/users.webp)
...
![filecont](/assets/img/htb-breadcrumbs/filecont.webp)
...
![cookie](/assets/img/htb-breadcrumbs/cookie.webp)
...
![cok](/assets/img/htb-breadcrumbs/cok.webp)

Let's try them one by one and check if we can get in

![adm1](/assets/img/htb-breadcrumbs/adm1.webp)

![adm.png](/assets/img/htb-breadcrumbs/adm.webp)
...
![issues](/assets/img/htb-breadcrumbs/Issues.webp)

Let's check the File management page

![file](/assets/img/htb-breadcrumbs/file.webp)

Let's try to upload anything to see if it works


![token](/assets/img/htb-breadcrumbs/token.webp)
...
![jwt](/assets/img/htb-breadcrumbs/jwt.webp)
...
![newjwt](/assets/img/htb-breadcrumbs/newjwt.webp)

Let's to import anything 

![succ](/assets/img/htb-breadcrumbs/succ.webp)
...
![foothold](/assets/img/htb-breadcrumbs/foothold.webp)
...
![data](/assets/img/htb-breadcrumbs/data.webp)

![userdata](/assets/img/htb-breadcrumbs/userdata.webp)
...
```
![userflag](/assets/img/htb-breadcrumbs/userflag.webp)
...
![userf](/assets/img/htb-breadcrumbs/userf.webp)
...
![todo1](/assets/img/htb-breadcrumbs/todo1.webp)
![todo2](/assets/img/htb-breadcrumbs/todo2.webp)
...
![sticky](/assets/img/htb-breadcrumbs/sticky.webp)
...
![state](/assets/img/htb-breadcrumbs/state.webp)
...
```
![smb](/assets/img/htb-breadcrumbs/smb.webp)
...
![sshdev](/assets/img/htb-breadcrumbs/sshdev.webp)
...
![ff](/assets/img/htb-breadcrumbs/ff.webp)
...
```
![kryp](/assets/img/htb-breadcrumbs/kryp.webp)
...
![rabin](/assets/img/htb-breadcrumbs/rabin.webp)
...
![local](/assets/img/htb-breadcrumbs/local.webp)
...
![for](/assets/img/htb-breadcrumbs/for.webp)
...
```
![us](/assets/img/htb-breadcrumbs/us.webp)

![AES](/assets/img/htb-breadcrumbs/AES.webp)

We get the administrator's password but it's encrypted (AES) 

Let's use cyberchef to decrypt it

![root](/assets/img/htb-breadcrumbs/root.webp)
...
![rooted](/assets/img/htb-breadcrumbs/rooted.webp)
